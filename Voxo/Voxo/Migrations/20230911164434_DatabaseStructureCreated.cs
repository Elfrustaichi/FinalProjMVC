...
{
    public partial class DatabaseStructureCreated : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UltraBannerSecondHeader = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: true),
                    Offer = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: true),
                    DiscountText = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: true),
                    Price = table.Column<decimal>(type: "money", nullable: false),
                    IsNewOffer = table.Column<bool>(type: "bit", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    Name = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: false),
                    CategoryTag = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: true),
                    BackgroundImageName = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RequestText = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Profession = table.Column<string>(type: "nvarchar(25)", maxLength: 25, nullable: false),
                    Rate = table.Column<int>(type: "int", nullable: false),
                    Comment = table.Column<string>(type: "nvarchar(255)", maxLength: 255, nullable: true),
                    OwnWebsite = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    SaleText = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: true),
                    TitleText = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: false),
                    OfferText = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: true),
                    BackgroundImageName = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false),
                    ButtonUrl = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: true),
                    ButtonHeaderText = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: true),
                    ButtonText = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: true),
                    ProductId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_UserCartItems_AspNetUsers_AppUserId",
                        column: x => x.AppUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserCartItems_AppUserId",
                table: "UserCartItems",
                column: "AppUserId");
